module voyagermesh.dev/apimachinery
...
require (
	...
	kmodules.xyz/crd-schema-fuzz v0.24.2-0.20220817193936-eeb628c0934d
	kmodules.xyz/monitoring-agent-api v0.24.1-0.20220817202031-7b31007edfc7
	kmodules.xyz/webhook-runtime v0.24.1-0.20220817201700-7a2ba54cc220
...
require (
	...
	k8s.io/apiextensions-apiserver v0.25.0-rc.1 // indirect
