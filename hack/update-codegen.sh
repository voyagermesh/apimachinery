...
# generation footprint -- every apis/voyager/<version> package carries a
...
THIS_PKG="voyagermesh.dev/apimachinery"
...
# "voyager:v1beta1,v1" -> voyager/v1beta1 voyager/v1.
group_versions=()
...
# Conversion helpers between apis/voyager/v1beta1 and apis/voyager/v1, the
# same scope the old ad hoc conversion-gen invocation used. apis/voyager/v1beta1's
# doc.go declares v1 as its +k8s:conversion-gen peer package, so
# conversion-gen discovers it without needing --extra-peer-dirs.
echo "Generating conversion code for apis/voyager/v1beta1"
"${GOBIN}/conversion-gen" \
    --go-header-file "${BOILERPLATE}" \
    --output-file zz_generated.conversion.go \
    "${THIS_PKG}/apis/voyager/v1beta1"
