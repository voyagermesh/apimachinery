...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"voyagermesh.dev/apimachinery/apis/voyager/v1.AuthOption":           schema_apimachinery_apis_voyager_v1_AuthOption(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.BasicAuth":            schema_apimachinery_apis_voyager_v1_BasicAuth(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.CoordinatorSpec":      schema_apimachinery_apis_voyager_v1_CoordinatorSpec(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.DNSResolver":          schema_apimachinery_apis_voyager_v1_DNSResolver(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.FrontendRule":         schema_apimachinery_apis_voyager_v1_FrontendRule(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.HTTPIngressBackend":   schema_apimachinery_apis_voyager_v1_HTTPIngressBackend(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.HTTPIngressPath":      schema_apimachinery_apis_voyager_v1_HTTPIngressPath(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.HTTPIngressRuleValue": schema_apimachinery_apis_voyager_v1_HTTPIngressRuleValue(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.Ingress":              schema_apimachinery_apis_voyager_v1_Ingress(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.IngressBackend":       schema_apimachinery_apis_voyager_v1_IngressBackend(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.IngressList":          schema_apimachinery_apis_voyager_v1_IngressList(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.IngressRef":           schema_apimachinery_apis_voyager_v1_IngressRef(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.IngressRule":          schema_apimachinery_apis_voyager_v1_IngressRule(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1.IngressRuleValue":     schema_apimachinery_apis_voyager_v1_IngressRuleValue(ref),
...
func schema_apimachinery_apis_voyager_v1_AuthOption(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"basic": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("voyagermesh.dev/apimachinery/apis/voyager/v1.BasicAuth"),
						},
					},
					"tls": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("voyagermesh.dev/apimachinery/apis/voyager/v1.TLSAuth"),
						},
					},
					"oauth": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1.OAuth"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"voyagermesh.dev/apimachinery/apis/voyager/v1.BasicAuth", "voyagermesh.dev/apimachinery/apis/voyager/v1.OAuth", "voyagermesh.dev/apimachinery/apis/voyager/v1.TLSAuth"},
	}
}

func schema_apimachinery_apis_voyager_v1_BasicAuth(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_voyager_v1_CoordinatorSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_apimachinery_apis_voyager_v1_DNSResolver(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_voyager_v1_FrontendRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"auth": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("voyagermesh.dev/apimachinery/apis/voyager/v1.AuthOption"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"voyagermesh.dev/apimachinery/apis/voyager/v1.AuthOption"},
	}
}

func schema_apimachinery_apis_voyager_v1_HTTPIngressBackend(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
		...
		Dependencies: []string{
			"k8s.io/api/networking/v1.IngressServiceBackend"},
	}
}

func schema_apimachinery_apis_voyager_v1_HTTPIngressPath(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"backend": {
						SchemaProps: spec.SchemaProps{
							Description: "Backend defines the referenced service endpoint to which the traffic will be forwarded to.",
							Default:     map[string]interface{}{},
							Ref:         ref("voyagermesh.dev/apimachinery/apis/voyager/v1.HTTPIngressBackend"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"voyagermesh.dev/apimachinery/apis/voyager/v1.HTTPIngressBackend"},
	}
}

func schema_apimachinery_apis_voyager_v1_HTTPIngressRuleValue(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "HTTPIngressRuleValue is a list of http selectors pointing to backends. In the example: http://<host>/<path>?<searchpart> -> backend where where parts of the url correspond to RFC 3986, this resource will be used to match against everything after the last '/' and before the first '?' or '#'.",
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1.HTTPIngressPath"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"voyagermesh.dev/apimachinery/apis/voyager/v1.HTTPIngressPath"},
	}
}

func schema_apimachinery_apis_voyager_v1_Ingress(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1.IngressSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1.IngressStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "voyagermesh.dev/apimachinery/apis/voyager/v1.IngressSpec", "voyagermesh.dev/apimachinery/apis/voyager/v1.IngressStatus"},
	}
}

func schema_apimachinery_apis_voyager_v1_IngressBackend(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressBackend describes all endpoints for a given service and port.",
...
func schema_apimachinery_apis_voyager_v1_IngressList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressList is a collection of Ingress.",
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1.Ingress"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "voyagermesh.dev/apimachinery/apis/voyager/v1.Ingress"},
	}
}

func schema_apimachinery_apis_voyager_v1_IngressRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_voyager_v1_IngressRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressRule represents the rules mapping the paths under a specified host to the related backend services. Incoming requests are first evaluated for a host match, then routed to the backend associated with the matching IngressRuleValue.",
				...
				Properties: map[string]spec.Schema{
					...
					"http": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("voyagermesh.dev/apimachinery/apis/voyager/v1.HTTPIngressRuleValue"),
						},
					},
					"tcp": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("voyagermesh.dev/apimachinery/apis/voyager/v1.TCPIngressRuleValue"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"voyagermesh.dev/apimachinery/apis/voyager/v1.HTTPIngressRuleValue", "voyagermesh.dev/apimachinery/apis/voyager/v1.TCPIngressRuleValue"},
	}
}

func schema_apimachinery_apis_voyager_v1_IngressRuleValue(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressRuleValue represents a rule to apply against incoming requests. If the rule is satisfied, the request is routed to the specified backend. Currently mixing different types of rules in a single Ingress is disallowed, so exactly one of the following must be set.",
...
func schema_apimachinery_apis_voyager_v1_IngressSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressSpec describes the Ingress the user wishes to exist.",
				...
				Properties: map[string]spec.Schema{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1.IngressTLS"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1.VolumeSource"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1.FrontendRule"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1.IngressRule"),
									},
								},
							},
						},
					...
					"coordinator": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("voyagermesh.dev/apimachinery/apis/voyager/v1.CoordinatorSpec"),
						},
					},
				},
			},
...
func schema_apimachinery_apis_voyager_v1_IngressTLS(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressTLS describes the transport layer security associated with an Ingress.",
...
func schema_apimachinery_apis_voyager_v1_OAuth(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_voyager_v1_TCPIngressRuleValue(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"backend": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("voyagermesh.dev/apimachinery/apis/voyager/v1.IngressBackend"),
						},
					},
					"alpn": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"voyagermesh.dev/apimachinery/apis/voyager/v1.IngressBackend"},
	}
}

func schema_apimachinery_apis_voyager_v1_TLSAuth(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_voyager_v1_Target(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_voyager_v1_VolumeSource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Represents the source of a volume to mount. Only one of its members may be specified.",
...
func schema_apimachinery_apis_voyager_v1_statsService(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
		...
		Dependencies: []string{
			"voyagermesh.dev/apimachinery/apis/voyager/v1.Ingress"},
	}
}
