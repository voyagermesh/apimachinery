...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressBackend":       schema_apimachinery_apis_voyager_v1beta1_IngressBackend(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressList":          schema_apimachinery_apis_voyager_v1beta1_IngressList(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressRef":           schema_apimachinery_apis_voyager_v1beta1_IngressRef(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressRule":          schema_apimachinery_apis_voyager_v1beta1_IngressRule(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressRuleValue":     schema_apimachinery_apis_voyager_v1beta1_IngressRuleValue(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressSpec":          schema_apimachinery_apis_voyager_v1beta1_IngressSpec(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressStatus":        schema_apimachinery_apis_voyager_v1beta1_IngressStatus(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressTLS":           schema_apimachinery_apis_voyager_v1beta1_IngressTLS(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.LocalTypedReference":  schema_apimachinery_apis_voyager_v1beta1_LocalTypedReference(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.OAuth":                schema_apimachinery_apis_voyager_v1beta1_OAuth(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.TCPIngressRuleValue":  schema_apimachinery_apis_voyager_v1beta1_TCPIngressRuleValue(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.TLSAuth":              schema_apimachinery_apis_voyager_v1beta1_TLSAuth(ref),
		"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.VolumeSource":         schema_apimachinery_apis_voyager_v1beta1_VolumeSource(ref),
	}
}
...
func schema_apimachinery_apis_voyager_v1beta1_AuthOption(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"basic": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.BasicAuth"),
						},
					},
					"tls": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.TLSAuth"),
						},
					},
					"oauth": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.OAuth"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.BasicAuth", "voyagermesh.dev/apimachinery/apis/voyager/v1beta1.OAuth", "voyagermesh.dev/apimachinery/apis/voyager/v1beta1.TLSAuth"},
	}
}

func schema_apimachinery_apis_voyager_v1beta1_BasicAuth(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_voyager_v1beta1_FrontendRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"auth": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.AuthOption"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/util/intstr.IntOrString", "voyagermesh.dev/apimachinery/apis/voyager/v1beta1.AuthOption"},
	}
}
...
func schema_apimachinery_apis_voyager_v1beta1_HTTPIngressRuleValue(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "HTTPIngressRuleValue is a list of http selectors pointing to backends. In the example: http://<host>/<path>?<searchpart> -> backend where where parts of the url correspond to RFC 3986, this resource will be used to match against everything after the last '/' and before the first '?' or '#'.",
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.HTTPIngressPath"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/util/intstr.IntOrString", "voyagermesh.dev/apimachinery/apis/voyager/v1beta1.HTTPIngressPath"},
	}
}

func schema_apimachinery_apis_voyager_v1beta1_Ingress(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressSpec", "voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressStatus"},
	}
}

func schema_apimachinery_apis_voyager_v1beta1_IngressBackend(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressBackend describes all endpoints for a given service and port.",
...
func schema_apimachinery_apis_voyager_v1beta1_IngressList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressList is a collection of Ingress.",
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.Ingress"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "voyagermesh.dev/apimachinery/apis/voyager/v1beta1.Ingress"},
	}
}

func schema_apimachinery_apis_voyager_v1beta1_IngressRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_voyager_v1beta1_IngressRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressRule represents the rules mapping the paths under a specified host to the related backend services. Incoming requests are first evaluated for a host match, then routed to the backend associated with the matching IngressRuleValue.",
				...
				Properties: map[string]spec.Schema{
					...
					"http": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.HTTPIngressRuleValue"),
						},
					},
					"tcp": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.TCPIngressRuleValue"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.HTTPIngressRuleValue", "voyagermesh.dev/apimachinery/apis/voyager/v1beta1.TCPIngressRuleValue"},
	}
}

func schema_apimachinery_apis_voyager_v1beta1_IngressRuleValue(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressRuleValue represents a rule to apply against incoming requests. If the rule is satisfied, the request is routed to the specified backend. Currently mixing different types of rules in a single Ingress is disallowed, so exactly one of the following must be set.",
...
func schema_apimachinery_apis_voyager_v1beta1_IngressSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressSpec describes the Ingress the user wishes to exist.",
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressTLS"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.VolumeSource"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.FrontendRule"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressRule"),
									},
								},
							},
						},
...
func schema_apimachinery_apis_voyager_v1beta1_IngressStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressStatus describe the current state of the Ingress.",
...
func schema_apimachinery_apis_voyager_v1beta1_IngressTLS(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IngressTLS describes the transport layer security associated with an Ingress.",
				...
				Properties: map[string]spec.Schema{
					...
					"ref": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("voyagermesh.dev/apimachinery/apis/voyager/v1beta1.LocalTypedReference"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"voyagermesh.dev/apimachinery/apis/voyager/v1beta1.LocalTypedReference"},
	}
}

func schema_apimachinery_apis_voyager_v1beta1_LocalTypedReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_apimachinery_apis_voyager_v1beta1_OAuth(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_voyager_v1beta1_TCPIngressRuleValue(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/util/intstr.IntOrString", "voyagermesh.dev/apimachinery/apis/voyager/v1beta1.IngressBackend"},
	}
}

func schema_apimachinery_apis_voyager_v1beta1_TLSAuth(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_apimachinery_apis_voyager_v1beta1_VolumeSource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Represents the source of a volume to mount. Only one of its members may be specified.",
