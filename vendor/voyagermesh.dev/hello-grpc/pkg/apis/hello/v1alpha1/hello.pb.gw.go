...
func request_HelloService_Intro_0(ctx context.Context, marshaler runtime.Marshaler, client HelloServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_HelloService_Intro_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_HelloService_Intro_0(ctx context.Context, marshaler runtime.Marshaler, server HelloServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq IntroRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.Intro(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterHelloServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HelloServiceServer) error {
	...
	mux.Handle("GET", pattern_HelloService_Intro_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/voyagermesh.dev.hellogrpc.apis.hello.v1alpha1.HelloService/Intro", runtime.WithHTTPPathPattern("/apis/hello/v1alpha1/intro/json"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_HelloService_Intro_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("POST", pattern_HelloService_Stream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterHelloServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HelloServiceClient) error {
	...
	mux.Handle("GET", pattern_HelloService_Intro_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/voyagermesh.dev.hellogrpc.apis.hello.v1alpha1.HelloService/Intro", runtime.WithHTTPPathPattern("/apis/hello/v1alpha1/intro/json"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_HelloService_Stream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/voyagermesh.dev.hellogrpc.apis.hello.v1alpha1.HelloService/Stream", runtime.WithHTTPPathPattern("/voyagermesh.dev.hellogrpc.apis.hello.v1alpha1.HelloService/Stream"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_HelloService_Stream_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"voyagermesh.dev.hellogrpc.apis.hello.v1alpha1.HelloService", "Stream"}, ""))
)
