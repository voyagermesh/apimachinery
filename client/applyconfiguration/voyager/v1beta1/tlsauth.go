...
type TLSAuthApplyConfiguration struct {
	...
	VerifyClient *v1beta1.TLSAuthVerifyOption `json:"verifyClient,omitempty"`
...
func (b *TLSAuthApplyConfiguration) WithVerifyClient(value v1beta1.TLSAuthVerifyOption) *TLSAuthApplyConfiguration {
