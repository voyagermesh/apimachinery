...
type IngressSpecApplyConfiguration struct {
	Backend                       *HTTPIngressBackendApplyConfiguration `json:"backend,omitempty"`
	...
	ProxySecurityContext          *v1.SecurityContext                   `json:"proxySecurityContext,omitempty"`
...
func (b *IngressSpecApplyConfiguration) WithBackend(value *HTTPIngressBackendApplyConfiguration) *IngressSpecApplyConfiguration {
	b.Backend = value
	return b
}
...
func (b *IngressSpecApplyConfiguration) WithResources(value v1.ResourceRequirements) *IngressSpecApplyConfiguration {
	b.Resources = &value
	return b
}
...
func (b *IngressSpecApplyConfiguration) WithAffinity(value v1.Affinity) *IngressSpecApplyConfiguration {
	b.Affinity = &value
	return b
}
...
func (b *IngressSpecApplyConfiguration) WithTolerations(values ...v1.Toleration) *IngressSpecApplyConfiguration {
	for i := range values {
...
func (b *IngressSpecApplyConfiguration) WithImagePullSecrets(values ...v1.LocalObjectReference) *IngressSpecApplyConfiguration {
	for i := range values {
...
func (b *IngressSpecApplyConfiguration) WithSecurityContext(value v1.PodSecurityContext) *IngressSpecApplyConfiguration {
...
func (b *IngressSpecApplyConfiguration) WithProxySecurityContext(value v1.SecurityContext) *IngressSpecApplyConfiguration {
...
func (b *IngressSpecApplyConfiguration) WithLivenessProbe(value v1.Probe) *IngressSpecApplyConfiguration {
...
func (b *IngressSpecApplyConfiguration) WithReadinessProbe(value v1.Probe) *IngressSpecApplyConfiguration {
