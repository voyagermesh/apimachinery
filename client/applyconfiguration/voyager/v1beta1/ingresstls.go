...
type IngressTLSApplyConfiguration struct {
	...
	Ref        *LocalTypedReferenceApplyConfiguration `json:"ref,omitempty"`
}
...
func (b *IngressTLSApplyConfiguration) WithRef(value *LocalTypedReferenceApplyConfiguration) *IngressTLSApplyConfiguration {
	b.Ref = value
	return b
}
