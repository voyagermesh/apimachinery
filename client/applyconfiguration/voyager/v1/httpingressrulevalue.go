...
func (b *HTTPIngressRuleValueApplyConfiguration) WithPort(value int32) *HTTPIngressRuleValueApplyConfiguration {
	b.Port = &value
	return b
}
...
func (b *HTTPIngressRuleValueApplyConfiguration) WithNodePort(value int32) *HTTPIngressRuleValueApplyConfiguration {
	b.NodePort = &value
	return b
}
