...
type IngressLister interface {
	...
	List(selector labels.Selector) (ret []*voyagerv1.Ingress, err error)
...
type ingressLister struct {
	listers.ResourceIndexer[*voyagerv1.Ingress]
}

// NewIngressLister returns a new IngressLister.
func NewIngressLister(indexer cache.Indexer) IngressLister {
	return &ingressLister{listers.New[*voyagerv1.Ingress](indexer, voyagerv1.Resource("ingress"))}
}

// Ingresses returns an object that can list and get Ingresses.
func (s *ingressLister) Ingresses(namespace string) IngressNamespaceLister {
	return ingressNamespaceLister{listers.NewNamespaced[*voyagerv1.Ingress](s.ResourceIndexer, namespace)}
}
...
type IngressNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*voyagerv1.Ingress, error)
