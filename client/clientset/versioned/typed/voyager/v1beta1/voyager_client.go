...
// NewForConfig creates a new VoyagerV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new VoyagerV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*VoyagerV1beta1Client, error) {
	...
	return &VoyagerV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new VoyagerV1beta1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *VoyagerV1beta1Client {
...
// New creates a new VoyagerV1beta1Client for the given RESTClient.
func New(c rest.Interface) *VoyagerV1beta1Client {
...
func (c *VoyagerV1beta1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
