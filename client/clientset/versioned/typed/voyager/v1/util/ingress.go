...
import (
	...
	cs "voyagermesh.dev/apimachinery/client/clientset/versioned/typed/voyager/v1"
...
func CreateOrPatchIngress(ctx context.Context, c cs.VoyagerV1Interface, meta metav1.ObjectMeta, transform func(alert *api.Ingress) *api.Ingress, opts metav1.PatchOptions) (*api.Ingress, kutil.VerbType, error) {
...
func PatchIngress(ctx context.Context, c cs.VoyagerV1Interface, cur *api.Ingress, transform func(*api.Ingress) *api.Ingress, opts metav1.PatchOptions) (*api.Ingress, kutil.VerbType, error) {
	return PatchIngressObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchIngressObject(ctx context.Context, c cs.VoyagerV1Interface, cur, mod *api.Ingress, opts metav1.PatchOptions) (*api.Ingress, kutil.VerbType, error) {
